...
class seg_decoder(nn.Module):
    ...
    def forward(self, feature_map, skip_8, skip_4):
        ...
        out = F.relu(self.conv_1x1_4(out)) # (shape: (batch_size, num_classes, h/4, w/4))
...
class inst_decoder(nn.Module):
    ...
    def forward(self, feature_map, skip_8, skip_4):
        ...
        out_center = F.relu(self.conv_1x1_4(out_center))

        # Regression prediction:
        out_regression = F.relu(self.conv_5x5_4(out))
        out_regression = F.relu(self.conv_1x1_5(out_regression))
        # print(out_center.shape)
        # print(out_regression.shape)
        # exit()
        return out_center, out_regression
